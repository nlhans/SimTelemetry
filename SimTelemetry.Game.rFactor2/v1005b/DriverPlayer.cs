...
namespace SimTelemetry.Game.rFactor2.v1005b
{
    public class DriverPlayer : IDriverPlayer
    {
        ...
        {
            // rfactor2.exe + 7F07A8
            get { return rFactor2.Game.ReadDouble(new IntPtr(0x17D07A8)); }
            set { throw new NotImplementedException(); }
        }
        ...
        public int Gear
        {
            get { return rFactor2.Drivers.Player.Gear; }
            set { throw new NotImplementedException(); }
        }
        ...
        public double Fuel
        {
            get { return  rFactor2.Drivers.Player.Fuel; }
            set { throw new NotImplementedException(); }
        }
        ...
        {
            get { return  rFactor2.Drivers.Player.RPM; }
            set { throw new NotImplementedException(); }
        }
        ...
        {
            get { return rFactor2.Game.ReadFloat(new IntPtr(rFactor2.Drivers.Player.BaseAddress + 0xE8)); }
            set { throw new NotImplementedException(); }
        }
        ...
        {
            get { return  rFactor2.Drivers.Player.Throttle; }
            set { throw new NotImplementedException(); }
        }

        public double Pedals_Brake
        {
            get { return  rFactor2.Drivers.Player.Brake; }
            set { throw new NotImplementedException(); }
        }
        ...
        public double Speed
        {
            get { return  rFactor2.Drivers.Player.Speed; }
            set { throw new NotImplementedException(); }
        }
