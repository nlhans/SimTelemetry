...
char     g_szPluginName[]     = "SimTelemetry rFactor plug-in";
...
const char*    InternalsPluginInfo::GetName()     const { return SimTelemetryPlugin::GetName(); }
const char*    InternalsPluginInfo::GetFullName() const { return m_szFullName; }
const char*    InternalsPluginInfo::GetDesc()     const { return "SimTelemetry rFactor plugin using MMF"; }
const unsigned InternalsPluginInfo::GetType()     const { return SimTelemetryPlugin::GetType(); }
const char*    InternalsPluginInfo::GetSubType()  const { return SimTelemetryPlugin::GetSubType(); }
const unsigned InternalsPluginInfo::GetVersion()  const { return SimTelemetryPlugin::GetVersion(); }
void*          InternalsPluginInfo::Create()      const { return new SimTelemetryPlugin(); }

const char SimTelemetryPlugin::m_szName[] = "SimTelemetry";
const char SimTelemetryPlugin::m_szSubType[] = "Telemetry";
const unsigned SimTelemetryPlugin::m_uID = 1;
const unsigned SimTelemetryPlugin::m_uVersion = 3;  // set to 3 for InternalsPluginV3 functionality and added graphical and vehicle info


PluginObjectInfo *SimTelemetryPlugin::GetInfo()
{
  return &g_PluginInfo;
}
